-- The following is grabbed from the jakelinnzy/autocmd-lua plugin
-- I copied it in rather than pulling in the plugin because it was a single
-- small file and this is simpler than pulling in a plugin in my setup
-- The real plugin can be found: https://github.com/jakelinnzy/autocmd-lua
local M = {}
